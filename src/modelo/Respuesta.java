...
public class Respuesta {
    ...
    public Respuesta(String res){
        ...
        idRespuesta = Integer.parseInt(split[0]);
        descripcionRespuesta = split[1];
        veracidadRespuesta = "true".equals(split[2]);
    }
    ...
    public String toString() {
        return getIdRespuesta() + "|" + getDescripcionRespuesta() + "|" + isVeracidadRespuesta();
    }
